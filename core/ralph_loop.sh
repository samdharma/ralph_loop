...
PREFLIGHT_SCRIPT="${RALPH_PREFLIGHT_SCRIPT:-${PROJECT_DIR}/scripts/ralph/ralph_preflight.sh}"
VALIDATE_SCRIPT="${RALPH_VALIDATE_SCRIPT:-${PROJECT_DIR}/scripts/ralph/ralph_validate.sh}"
METRICS_SCRIPT="${RALPH_METRICS_SCRIPT:-${PROJECT_DIR}/scripts/ralph/ralph_metrics.sh}"
